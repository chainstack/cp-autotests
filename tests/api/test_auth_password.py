...
class TestPasswordChange:
    ...
    @pytest.mark.smoke
    def test_change_password_success(self, authenticated_auth_client, valid_credentials):
    ...
    def test_change_password_missing_old_password(self, authenticated_auth_client):
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_change_password_missing_new_password(self, authenticated_auth_client):
        response = authenticated_auth_client.put(
            "/v1/auth/password",
    ...
    def test_change_password_empty_old_password(self, authenticated_auth_client, old_password):
        response = authenticated_auth_client.change_password(
    ...
    def test_change_password_empty_new_password(self, authenticated_auth_client, new_password):
        response = authenticated_auth_client.change_password(
            old_password="oldpass123",
    ...
    def test_change_password_nonstring_old_password(self, authenticated_auth_client, old_password):
        response = authenticated_auth_client.put(
            "/v1/auth/password",
    ...
    def test_change_password_nonstring_new_password(self, authenticated_auth_client, new_password):
        response = authenticated_auth_client.put(
            "/v1/auth/password",
            json={"old_password": "oldpass123", "new_password": new_password}
        )
    ...
    @allure.severity(allure.severity_level.NORMAL)
    @pytest.mark.parametrize("weak_password", ["123", "abc", "password", "12345678"])
    def test_change_password_weak_password(self, authenticated_auth_client, weak_password):
        response = authenticated_auth_client.change_password(
            old_password="oldpass123",
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_change_password_same_passwords(self, authenticated_auth_client):
        response = authenticated_auth_client.change_password(
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_change_password_extra_fields(self, authenticated_auth_client):
        response = authenticated_auth_client.put(
            "/v1/auth/password",
            json={
                "old_password": "oldpass123",
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_change_password_wrong_old_password(self, authenticated_auth_client):
        response = authenticated_auth_client.change_password(
            old_password="WrongPassword123!",
            new_password="NewSecurePassword123!"
        )
        
        assert response.status_code in [400, 401, 501], f"Expected 400, 401 or 501, got {response.status_code}"
